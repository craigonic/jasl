...
temporaryStack = unitList[2].takePortagedItem(list(portagedItems.keys())[0])
...
print("Null Stack argument to Stack.addSubStack():")
...
newStack = temporaryStack.takeSubStack(list(subStacks.keys())[1])
