...
//                                                                            //
// $Id: Mobile.java,v 1.15 2009/12/31 06:28:50 craig Exp $
// ************************************************************************** //
...
class Mobile extends Fighting
{
	...
	protected Mobile(Descriptions description,String nationality,
	                 String identity,String unitType,String firepower,
	                 int normalRange,int portageValue,
	                 boolean sprayFireCapable,int movement,
	                 int portageCapacity)
	{
		// Pass the first 8 parameters to the superclass constructor. If
		...
		super(description,nationality,identity,unitType,firepower,
		      normalRange,portageValue,sprayFireCapable);
		...
		this.portageLevel = MIN_PORTAGE_LEVEL; // Assume that this value
		                                       // will be determined
		                                       // after the object is
		                                       // instantiated.
	}
	 ...
	 * unit before it begins to move. This value may be affected by the
	 * current portage level of the unit.
	 *
	 ...
	 * equipment that this unit can carry without affecting the movement
	 ...
	 * equipment that this unit is currently carrying.
	 *
