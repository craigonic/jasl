...
//                                                                            //
// $Id: Squad.java,v 1.16 2010/01/16 05:25:54 craig Exp $
// ************************************************************************** //
...
public final class Squad extends Personnel
{
	             ...
	             boolean assaultFireCapable,int smokePlacementExponent)
	{
		...
		super(Descriptions.SQUAD,nationality,identity,unitType,
		      firepower,normalRange,sprayFireCapable,morale,
		      brokenMorale,selfRallyCapable,basicPointValue,
		      experienceLevelRating,hasMaximumELR,classification);
	...
	public String toString()
	{
		...
		returnString.append(Messages.formatTextString(getSPE(),
	...
	/**
	 * Indicate if this Squad has assault fire and movement capabilities.
	...
	/**
	 * Return the smoke placement capability of this Squad. This is
