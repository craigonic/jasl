...
abstract class Fighting extends Unit
{
	 ...
	 * the unit's nationality, type, or capability.
	 ...
	 * to another unit to carry this unit. If the value is
	 * <A HREF=#MAX_PORTAGE_VALUE>MAX_PORTAGE_VALUE</A> the unit may not be
	 * carried.
	 ...
	 * The list will include one or more of the string constants, defined in the
	 ...
	 * @param newStatus the new status. This value will be used as a mask to set
	 * a one or more bits in the status value.
	 * @see #getStatus
	 */
