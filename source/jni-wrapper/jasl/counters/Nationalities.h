 ...
 * <A HREF="../../../jasl/counters/Nationality.html">Nationalities</A> enum, which is implemented in <A HREF="http://java.sun.com/">Java</A>, for use in C/C++ programs.
 *
...
/**
 * \brief <A HREF="../../../jasl/counters/Nationality.html">Nationalities</A> enum <A HREF="http://gcc.gnu.org/onlinedocs/gcj/About-CNI.html#About-CNI">CNI</A> (Compiled Native Interface) proxy.
 *
